...
def create_app_ui() -> ui.Tag:
    ...
    return ui.page_fluid(
        ...
        ui.layout_column_wrap(
            ui.card(
                ui.card_header("AI‑Generated Executive Summary"),
                ui.markdown(
                    """
                    This summary is generated by an AI model (Ollama cloud) using the same
                    quarterly returns data shown above. Use it as a quick narrative overview,
                    and always cross‑check with the chart and table.
                    """
                ),
